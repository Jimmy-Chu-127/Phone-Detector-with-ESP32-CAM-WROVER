...
void setupCommunication() {
  #if USE_BT
<<<<<<< Updated upstream:Project/Design Challenge/WifiCam2/Communication.ino
    // Ser.begin("HCSpark2"); // HC Bluetooth name
    Ser.begin("Jean Gorby's ESP32CAM"); // JG Bluetooth name
=======
    Ser.begin("HCSpark-tem"); // any unique name for BT
>>>>>>> Stashed changes:Project/Design Challenge/Bluetooth_receiver/Communication.ino
  #else
    Ser.begin(115200);
  #endif
}
